...
namespace Graphy.NoiseAlgorithms
{
    public class SimplexNoise
    {
        public float Evaluate(float x) => Generate(x);

        public float Evaluate(float x, float y) => Generate(x, y);

        public float Evaluate(float x, float y, float z) => Generate(x, y, z);
